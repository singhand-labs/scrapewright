...
describe('KnowledgeBase', () => {
  ...
  it('every seed unit matchEvents value is inside the documented vocabulary', () => {
    const VOCAB = new Set(['COUNT_SHORTFALL', 'EMPTY_EXTRACTION', 'EMPTY_FIELDS', 'POPOVER_TIMEOUT',
      ...
      'SCROLL_COUNT_FROZEN', 'DUPLICATE_ID_VALUES', 'COUNT_FIELD_HIDDEN_VALUE', 'TIME_FIELD_IMPLAUSIBLE', 'STAGNANT_DISCLOSURES', 'POSITION_LIKE_ID', 'LABEL_PREFIXED_COUNT',
      'REQUIRED_FIELD_EMPTY', 'JUNK_VALUES', 'JUNK_DOMINATED', 'SCHEMA_STRAY_FIELD_DECLS', 'JUNK_SHAPE_RECORDS', 'FIELD_MATCH_ZERO', 'TIME_SOURCE_UNEXERCISED']);
    for (const u of KNOWLEDGE_UNITS) {
